...
export const staticMetadata: DeployedPlugin[] = [
    {
        type: 0,
        metadata: {
            host: 'main',
            model: {
                id: 'vscode_typescript-language-features',
                ...
                entryPoint: {
                    frontend: './dist/browser/extension',
                    backend: undefined
                },
                iconUrl: 'hostedPlugin/vscode_typescript_language_features/media/icon.png',
                readmeUrl: 'undefined',
                licenseUrl: 'hostedPlugin/vscode_typescript_language_features/.%2FLICENSE',
                packageUri: 'hostedPlugin/vscode_typescript_language_features',
                packagePath: 'lib/frontend/hostedPlugin/vscode_typescript_language_features',
                l10n: 'undefined'
            },
            lifecycle: {
...

    {
        ...
        metadata: {
            ...
            model: {
                ...
                packageUri: 'hostedPlugin/vscode_typescript',
                packagePath: 'lib/frontend/hostedPlugin/vscode_typescript'
            },
            lifecycle: {
                startMethod: 'activate',
                stopMethod: 'deactivate',
